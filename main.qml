...
Window {
  ...
  property string temporaryFile: "file:///D:/First_GUI/build/Desktop_Qt_6_7_0_MinGW_64_bit-Debug/temporary_file.jpg"
        ...
        Rectangle {
          ...
          Button {
            ...
            onClicked: {
              ...
              if (widthInput <= 0 || heightInput <= 0 || isNaN(heightInput)
                  || isNaN(widthInput)) {
              ...
              if (!isFirst) {
                imageProcessor14.applyResize(fileOpenDialog.currentFile,
                ...
                imageProcessor14.applyResize(temporaryFile, widthInput,
                                             heightInput)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
    ...
    MouseArea {
      ...
      Menu {
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor13.applyMerge(fileOpenDialog.currentFile,
                                          filename, 1)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              ...
              imageProcessor13.applyMerge(temporaryFile, filename, 1)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
            }
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              ...
              imageProcessor13.applyMerge(temporaryFile, filename, 2)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
            }
        ...
        Rectangle {
          ...
          Button {
            ...
            onClicked: {
              ...
              if (angleInput > 90 || isNaN(angleInput) || angleInput < 0) {
              ...
              if (!isFirst) {
                imageProcessor16.applySkewing(fileOpenDialog.currentFile,
                                              angleInput)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
                ...
                imageProcessor16.applySkewing(temporaryFile, angleInput)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
              }
          ...
          Button {
            ...
            onClicked: {
              ...
              if (!isFirst2) {
                ...
                original_width = imageProcessor21.checkCropWidth(temporaryFile)
                original_height = imageProcessor22.checkCropHeight(
                      temporaryFile)
              }

              if (widthInput1 <= 0 || heightInput1 <= 0 || isNaN(
                    heightInput1) || xpoint < 0 || ypoint < 0 || isNaN(widthInput1) || isNaN(
              ...
              if (!isFirst) {
                imageProcessor23.applyCrop(fileOpenDialog.currentFile,
                ...
                imageProcessor23.applyCrop(temporaryFile, widthInput1,
                                           heightInput1, xpoint, ypoint)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
              }
    ...
    MouseArea {
      ...
      Menu {
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor18.applyBlur(fileOpenDialog.currentFile, 1)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor18.applyBlur(fileOpenDialog.currentFile, 2)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor18.applyBlur(fileOpenDialog.currentFile, 3)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        Rectangle {
          ...
          Button {
            ...
            onClicked: {
              ...
              if (degree1 < 0 || isNaN(degree1) || degree1 > 255) {
                errorText_submenu1.visible = true
                return
              }

              if (!isFirst) {
                imageProcessor19.applyBrightness(fileOpenDialog.currentFile,
                                                 degree1, 1)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
                ...
                imageProcessor19.applyBrightness(temporaryFile, degree1, 1)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
              }
        ...
        Rectangle {
          ...
          Button {
            ...
            onClicked: {
              ...
              if (degree2 < 0 || isNaN(degree2) || degree2 > 255) {
              ...
              if (!isFirst) {
                ...
                imageProcessor19.applyBrightness(temporaryFile, degree2, 2)
                second_image.cache = true
                second_image.imageSource = temporaryFile
                second_image.cache = false
              }
    ...
    MouseArea {
      ...
      Menu {
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor15.applyFlip(fileOpenDialog.currentFile, 1)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor15.applyFlip(fileOpenDialog.currentFile, 2)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
    ...
    MouseArea {
      ...
      Menu {
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor17.applyRotate(fileOpenDialog.currentFile, 90)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor17.applyRotate(fileOpenDialog.currentFile, 180)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
        ...
        MenuItem {
          ...
          onTriggered: {
            if (!isFirst) {
              imageProcessor17.applyRotate(fileOpenDialog.currentFile, 270)
              second_image.cache = true
              second_image.imageSource = temporaryFile
              second_image.cache = false
              isFirst = true
          ...
          Button {
            ...
            onClicked: {
              var return1 = imageProcessor12.savingImage(
                    fileOpenDialog.currentFile, savefilename.text)
              if (return1 === 1) {
  ...
  Rectangle {
    ...
    property color baseColor30: "#F2F2F2"
    color: buttonMouseArea50.pressed ? Qt.darker(
                                         baseColor30) : buttonMouseArea50.containsMouse ? Qt.lighter(baseColor30) : baseColor30
    x: 1033
    y: 11
    width: 55
    height: 34
      ...
      Popup {
        ...
        Rectangle {
          ...
          Column {
            ...
            Text {
              id: developedby
              text: "This app was developed in FCAI, Cairo University"
            }
            Text {
              id: whitespace
              text: " "
            ...
            Text {
              id: name1
              text: "1) Ezzeldin Omar Abd El-latif (ezzeldinomar7@gmail.com)"
            }
            Text {
              id: name2
              text: "2) Ibrahim Mohamed Saad Mohamed (hes93314@gmail.com)"
            }
            Text {
              id: name3
              text: "3) Ahmed Hussein Mohamed Ahmed (hzrdu3500@gmail.com)"
            }
            Text {
              id: whitespace3
              text: " "
            ...
            Text {
              id: supervision
              text: "Under supervision: Dr. Mohammed El-Ramly"
            }
          }
        }
      }
